...
const DeleteCategoryModal: React.FC<Props> = ({ 
  isOpen, onClose, onConfirm, isLoading, categoryName, errorMessage 
}) => {
  const footer = (
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Delete Category" footer={footer}>
      <div style={{ textAlign: 'center', padding: '1rem 0' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: 0 }}>
          This action cannot be undone. All habits associated with this category might be affected.
        </p>
      </div>
