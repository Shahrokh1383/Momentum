...
namespace App\Http\Controllers\User\Habit;
...
class HabitController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return $this->successResponse(HabitResource::collection($habits), 'Active habits retrieved successfully.');
    }

    public function archived(Request $request): JsonResponse
    {
        $habits = $this->habitService->getArchivedHabits($request->user());
        return $this->successResponse(HabitResource::collection($habits), 'Archived habits retrieved successfully.');
    }
    ...
    public function store(StoreHabitRequest $request): JsonResponse
    {
        ...
        return $this->successResponse(new HabitResource($habit), 'Habit created successfully.', 201);
    }

    public function show(Request $request, int $id): JsonResponse
    {
        $habit = $this->habitService->getHabitById($request->user(), $id);
        return $this->successResponse(new HabitResource($habit), 'Habit retrieved successfully.');
    }
    ...
    public function update(UpdateHabitRequest $request, Habit $habit): JsonResponse
    {
        ...
        return $this->successResponse(new HabitResource($habit), 'Habit updated successfully.');
    }
    ...
    public function archive(Request $request, int $id): JsonResponse
    {
        ...
        return $this->successResponse(new HabitResource($habit), 'Habit archived successfully.');
    }

    public function restore(Request $request, int $id): JsonResponse
    {
        $habit = $this->habitService->restoreHabit($request->user(), $id);
        return $this->successResponse(new HabitResource($habit), 'Habit restored successfully.');
    }
